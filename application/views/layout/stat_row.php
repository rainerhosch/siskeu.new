    ...
    <div class="col-sm-6">
        <a href="page_widgets_stats.html" class="widget widget-hover-effect1">
            <div class="widget-simple">
                ...
                <div class="pull-right"><span id="mini-chart-brand"><canvas width="176" height="64" style="display: inline-block; width: 176px; height: 64px; vertical-align: top;"></canvas></span>
                </div>
                <h3 class="widget-content animation-pullDown visible-lg">
