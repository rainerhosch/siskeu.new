...
<div class="modal fade shadow-md" id="formPembayaranLain" tabindex="-1" role="dialog"
    aria-labelledby="formPembayaranTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal_body">
                <div class="row">
                    <div class="alert alert-info" role="alert">Untuk Pembayaran Perpanjang Semester, Jika Mahasiswa
                        Mempunya tunggakan di semester lalu, silahkan tambah transaksi/pembayaran "Tunggakan CS" pada
                        (pilihan pembayaran).</div>
                    <div class="col-sm-4 form_invoice2">
                        <div class="sm-form mb-5 row" style="margin-top: 5px;">
                            <div class="col-sm-12">
                                <input type="text" id="nipd_2" name="nipd_2" class="form-control validate"
                        ...
                        <div class="sm-form mb-5 row text-left">
                            <div class="col-sm-12">
                                <input type="text" id="nama_mhs_2" name="nama_mhs_2" class="form-control validate"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <form id="form_pembayaran_lain" enctype="multipart/form-data">
                            <div class="sm-form mb-5 row text-left">
                                <div class="col-sm-12">
                                    <input type="hidden" id="nim_mhs_bayar_hidden" name="nim_mhs_bayar_hidden"
                                        class="form-control validate" readonly>
                                    <input type="hidden" id="nama_mhs_bayar_hidden" name="nama_mhs_bayar_hidden"
                                        class="form-control validate" readonly>
                                    <input type="hidden" id="jenjang_mhs_bayar_hidden" name="jenjang_mhs_bayar_hidden"
                                        class="form-control validate" readonly>
                                    <input type="hidden" id="angkatan_mhs_bayar_hidden" name="angkatan_mhs_bayar_hidden"
                                        class="form-control validate" readonly>
                                    <input type="hidden" id="id_konfirm_trf" name="id_konfirm_trf"
                                        class="form-control validate" readonly>
                                    <input type="hidden" id="tg_cs_mhs" name="tg_cs_mhs" class="form-control validate"
                                        readonly>
                                    <input type="hidden" id="tg_kmhs" name="tg_kmhs" class="form-control validate"
                                        readonly>
                            ...
                            <div class="col-sm-9 text-left">
                                <button type="button" id="add_rows" class="btn btn-success text-left div_btn_row"
                                    disabled><i class="gi gi-plus"></i></button>
                                <button type="button" id="delete_rows" class="btn btn-danger div_btn_row" disabled><i
                                        class="hi hi-minus"></i></button>
                            </div>
                    ...
                    if (response.dataHistoriTX != null) {
                        $.each(response.dataHistoriTX, function (i, value) {
                            ...
                            $.each(value.detail_transaksi, function (k, val) {
                                html_tbody_2 += `<i style="font-size:1rem; font-weight: bold;">${val.nm_jenis_pembayaran
